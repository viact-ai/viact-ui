...
function AlertEmpty({
  ...
  return (
    <svg
      ...
      <path
        fill="currentColor"
        d="M60 52.98a37.45 37.45 0 0 1 37.48 36.25l.02 1.25v20.485l6.9 15.78a6.24 6.24 0 0 1-.495 5.924 6.24 6.24 0 0 1-5.23 2.826L75 135.51a15 15 0 0 1-14.558 15.013 15 15 0 0 1-15.417-14.128l-.025-.9H21.375a6.26 6.26 0 0 1-5.222-2.822 6.26 6.26 0 0 1-.513-5.913l6.86-15.79V90.48c0-20.775 16.76-37.5 37.5-37.5m7.5 82.52-15 .01a7.499 7.499 0 0 0 12.405 5.675 7.5 7.5 0 0 0 2.56-4.95zM60 60.48c-16.6 0-30 13.37-30 30v22.05L23.28 128h73.485L90 112.535v-21.99l-.015-1.125A29.94 29.94 0 0 0 60 60.48"
      />
