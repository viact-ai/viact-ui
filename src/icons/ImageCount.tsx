  ...
  return (
    <svg
      ...
      <path
        fill="#56CCF2"
        fillRule="evenodd"
        d="M11.104 6.943c1.925.113 2.96 1.128 3.105 3.047-.153 1.833-1.15 2.83-2.988 2.989-2.1-.235-3.086-1.407-2.96-3.516.374-1.497 1.321-2.337 2.843-2.52Z"
        clipRule="evenodd"
        opacity={0.977}
      />
    </svg>
