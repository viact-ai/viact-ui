...
function InsufficientDiskSpace({ title, titleId, ...props }) {
    return (React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 42 42", "aria-labelledby": titleId, ...props },
        ...
        React.createElement("g", { fill: "#fff", clipPath: "url(#insufficient-disk-space_svg__a)" },
            React.createElement("path", { d: "M28.716 14.386a1.278 1.278 0 0 0-1.227-.914H13.511a1.278 1.278 0 0 0-1.233.94l-1.815 7.366h20.074l-1.82-7.392ZM10.278 23.056v4.472a1.278 1.278 0 0 0 1.278 1.278h17.888a1.278 1.278 0 0 0 1.278-1.278v-4.472H10.278Zm17.889 3.194H25.61v-1.278h2.556v1.278Z" })),
