...
function AlertEmpty({ title, titleId, ...props }) {
    return (React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 150 165", "aria-labelledby": titleId, ...props },
        ...
        React.createElement("path", { fill: "currentColor", d: "M60 52.98a37.45 37.45 0 0 1 37.48 36.25l.02 1.25v20.485l6.9 15.78a6.242 6.242 0 0 1-.495 5.924 6.236 6.236 0 0 1-5.23 2.826L75 135.51a14.998 14.998 0 0 1-14.558 15.013 15.002 15.002 0 0 1-15.417-14.128l-.025-.9H21.375a6.259 6.259 0 0 1-5.222-2.822 6.257 6.257 0 0 1-.513-5.913l6.86-15.79V90.48c0-20.775 16.76-37.5 37.5-37.5Zm7.5 82.52-15 .01a7.499 7.499 0 0 0 12.405 5.675 7.5 7.5 0 0 0 2.56-4.95l.035-.735ZM60 60.48c-16.6 0-30 13.37-30 30v22.05L23.28 128h73.485L90 112.535v-21.99l-.015-1.125A29.94 29.94 0 0 0 60 60.48Z" }),
