...
function Whatsapp({ title, titleId, ...props }) {
    return (React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 42 42", "aria-labelledby": titleId, ...props },
        ...
        React.createElement("g", { clipPath: "url(#whatsapp_svg__a)" },
            React.createElement("path", { fill: "#00E676", d: "m15.343 29.553.392.194c1.635.97 3.466 1.422 5.297 1.422 5.755 0 10.464-4.654 10.464-10.343 0-2.714-1.112-5.365-3.074-7.304a10.45 10.45 0 0 0-7.39-3.038c-5.754 0-10.463 4.654-10.398 10.407 0 1.94.589 3.814 1.57 5.43l.261.388-1.046 3.813 3.924-.97Z" }),
